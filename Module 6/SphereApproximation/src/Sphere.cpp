...
Sphere::Sphere(std::vector<float> p1, std::vector<float> p2, std::vector<float> p3,std::vector<float> p4){
    point1 = p1;
    point2 = p2;
    point3 = p3;
    point4 = p4;
...
void Sphere::generateVertices(int subDivideCount){
    ...
    pushbackTriangle(face1);
    pushbackTriangle(face2);
    pushbackTriangle(face3);
    pushbackTriangle(face4);
}
